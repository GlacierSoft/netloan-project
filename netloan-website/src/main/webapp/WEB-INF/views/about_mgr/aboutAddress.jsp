   ...
   $(function(){
	   //创建和初始化地图函数：
	    ...
	    function createMap(){
	        ...
	        var point = new BMap.Point(113.571477,22.376556);//定义一个中心点坐标
	    ...
	    //标注点数组
	    var markerArr = [{title:"我的标记",content:"珠海冰川科技有限公司",point:"113.570122|22.376385",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
			 ];
	    //创建marker
	    function addMarker(){
	    ...
	    //标注线数组
	    var plPoints = [{style:"solid",weight:4,color:"#f00",opacity:0.6,points:["113.57014|22.377162","113.575602|22.376359","113.569853|22.377696"]}
			 ];
	    //向地图中添加线函数

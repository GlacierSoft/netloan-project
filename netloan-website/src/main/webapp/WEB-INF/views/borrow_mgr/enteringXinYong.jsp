    ...
    <div class="container">
  	<div class="row">
    	...
    	<div>
    		...
    		<div>
    			<form id="enteringXinYong" name="enteringXinYong" class="form-horizontal" role="form" method="post" >
		          <table  style="width: 950px;">
					  ...
					  <tr>
					    ...
					    <td class="col-md-6"> <input type="hidden" id="loanTenderId" name="loanTenderId" value="1c362eac7ec315aa47ab84360d4e390d"/>信用标</td>
					  </tr>
					  <tr>

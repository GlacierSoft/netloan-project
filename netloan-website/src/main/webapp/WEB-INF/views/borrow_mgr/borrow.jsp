			 	...
			 	<div class="panel panel-default" style="width: 284px;">       
			        ...
			        <div class="lc_middle_items_middle ">
			          ...
			          <div class="borrow_detail_more">
			           <a href="${ctx}/borrowingLoan/borrowLiuZhuan.htm">详情介绍&gt;&gt;</a>
			          </div>
			          <div class="lc_middle_items_middle_bot">
			            <a href="${ctx}/borrowingLoan/borrowLiuZhuan.htm" class="bot">立即申请</a>
			          </div>
			        </div>
				</div>
			</div>
			...
			<div class="col-md-3">
			 	<div class="panel panel-default" style="width: 284px;">       
			        ...
			        <div class="lc_middle_items_middle ">
			          ...
			          <div class="borrow_detail_more">
			           <a href="${ctx}/borrowingLoan/borrowDiYa.htm">详情介绍&gt;&gt;</a>
			          </div>
			          <div class="lc_middle_items_middle_bot">
			            <a href="${ctx}/borrowingLoan/borrowDiYa.htm" class="bot">立即申请</a>
			          </div>
			        </div>
				</div>
			</div>
			...
			<div class="col-md-3">
			 	<div class="panel panel-default" style="width: 284px;">       
			        ...
			        <div class="lc_middle_items_middle ">
			          ...
			          <div class="borrow_detail_more">
			           <a href="${ctx}/borrowingLoan/borrowXinYong.htm">详情介绍&gt;&gt;</a>
			          </div>
			          <div class="lc_middle_items_middle_bot">
			            <a href="${ctx}/borrowingLoan/borrowXinYong.htm" class="bot">立即申请</a>
			          </div>
			        </div>
				</div>
			</div>
			<div class="col-md-3">
			 	<div class="panel panel-default" style="width: 284px;">       
			        ...
			        <div class="lc_middle_items_middle ">
			          ...
			          <div class="borrow_detail_more">
			           <a href="${ctx}/borrowingLoan/borrowJingZhi.htm">详情介绍&gt;&gt;</a>
			          </div>
			          <div class="lc_middle_items_middle_bot">
			            <a href="${ctx}/borrowingLoan/borrowJingZhi.htm" class="bot">立即申请</a>
			          </div>
			        </div>
				</div>
			</div>

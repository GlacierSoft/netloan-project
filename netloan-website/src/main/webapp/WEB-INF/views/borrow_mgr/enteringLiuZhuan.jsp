    ...
    <div class="container">
  	<div class="row">
    	...
    	<div>
    		...
    		<div>
    			<form id="enteringLiuZhuan" name="enteringLiuZhuan" class="form-horizontal" role="form" method="post" onsubmit="return checkCreditamount();">
		          <table style="width: 950px;" border="0">
					  ...
					  <tr>
					    ...
					    <td class="col-md-6"><input type="text" name="loanApr"  class="inp280" onkeyup="clearNoNum(this)" maxlength="6" />%</td>
					  </tr>
					</tbody>
			      </table>
			      ...
			      <table  style="width: 950px;">
					  ...
					  <tr>
		          	  	<td align="right"><b style="margin-right: 20px;">提交借款信息</b></td><td></td>
		          	  </tr>
					  <tr>
    ...
    <script type="text/javascript">
		...
		function checkFixedAppReward(){
			...
			if(lowestRewardPro <= parseFloat($bidProRewardValues)&&parseFloat($bidProRewardValues)<=largestRewardPro){//比较
				...
				document.getElementById("fixedAppRewardCheck").innerHTML="<font style='color: #F00;font-style: italic;font-weight: bold;float:left;'>请输入${loanTenderDate.lowestRewardMoney}"+"元 - "+"${loanTenderDate.largestRewardMoney}元的奖励金额</font>";
			}
		}

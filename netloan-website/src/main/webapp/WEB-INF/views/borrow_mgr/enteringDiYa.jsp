    			...
    			<form id="enteringDiYa" name="enteringDiYa" class="form-horizontal" role="form" method="post" onsubmit="return checkCreditamount();">
			      ...
			      <table  style="width: 950px;">
					  ...
					  <tr>
					    ...
					    <td class="col-md-6">
					    	<input type="radio" id="isBidReward" name="isBidReward" checked="checked" value="no" onclick="displayIsBidReward()" onkeyup="clearNoNum(this)" maxlength="6"/>
					      	不设置奖励
					    </td>
					  </tr>
					  <tr>
					    ...
					    <td class="col-md-6">
					     	...
					     	按投标金额比例奖励
					     	<input type="text" onblur="checkBidProReward();" id="bidProReward" name="bidProReward" class="inp100x gray" disabled="disabled" value="0" onkeyup="clearNoNum(this)" maxlength="6"/>
					     	<span id="bidProRewardCheck"></span>
					      %
					    </td>
					  </tr>
					  <tr>
					    ...
					    <td class="col-md-6">
					     	<input type="radio" id="isBidReward" name="isBidReward" value="yes" onclick="displayIsBidReward()"/>
					      	按固定金额分摊奖励
					      	<input type="text" onblur="checkFixedAppReward();" id=fixedAppReward name="fixedAppReward" class="inp100x gray" disabled="disabled" value="0" onkeyup="clearNoNum(this)" maxlength="6"/><span id="fixedAppRewardCheck"></span>
					      	元
					    </td>
					  </tr>
					  <tr>

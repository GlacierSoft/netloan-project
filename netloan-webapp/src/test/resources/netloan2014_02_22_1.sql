...
-- Records of t_member
-- ----------------------------
INSERT INTO `t_member` VALUES ('0d06ae74d5a50659c4c40d4ee980a748', 'cc', 'cc', 'cc', '24', '13798985547', 'man', 'single', 'cc', 'cc', '2014-02-21 15:42:33', '0', '0', 'enable', 'general', null, null, 'cc', 'cc', 'cc', 'cc', 'cc', '3242334', 'cc', 'friend', 'cc', 'cc', 'cc', 'friend', 'cc', 'cc', '8b25651c2d896297530b64e4b80ec503', '2014-02-21 15:42:33', '8b25651c2d896297530b64e4b80ec503', '2014-02-21 15:42:33');
INSERT INTO `t_member` VALUES ('225b8f6a7863d52f947b265f869e48be', 'eeee', 'ee', 'ee', '23', '3242424', 'woman', 'married', '440583199110302853', '58454@qd.com', '2014-02-21 16:26:38', '0', '0', 'enable', 'general', null, null, 'ee', 'ee', 'ee', 'ee', '34', '32434243', 'ee', 'family', '3242424', 'ee', 'ee', 'business', '3242424', 'ee', '8b25651c2d896297530b64e4b80ec503', '2014-02-21 16:26:38', '8b25651c2d896297530b64e4b80ec503', '2014-02-21 17:40:09');
INSERT INTO `t_member` VALUES ('aaaaa', 'aa', 'aa', 'aa', '32', '323333', 'man', 'married', '3233232323', 'sdfasd', '2014-02-21 10:19:11', '32', '34', 'enable', 'vip', '2014-02-21 10:19:27', '2014-02-21 10:19:30', 'aa', 'aa', 'aa', 'aa', 'aa', 'aa', 'aa', 'family', 'aa', 'aa', 'aa', 'friend', 'aa', 'aa', '8b25651c2d896297530b64e4b80ec503', '2014-02-21 10:20:26', '8b25651c2d896297530b64e4b80ec503', '2014-02-21 10:20:29');
INSERT INTO `t_member` VALUES ('adf', 'asd', 'asfd', 'afd', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `t_member` VALUES ('af', 'gggg', 'asdf', 'afsd', '23', '23112221', 'secret', 'married', '440583199110302853', '322333223@qq.do', null, null, null, 'enable', 'vip', null, null, '', '', '', '32', '32', '33232332', '32', 'friend', '32332332', '3d', '32', 'friend', '32332323', '32', null, null, '8b25651c2d896297530b64e4b80ec503', '2014-02-21 17:56:30');
INSERT INTO `t_member` VALUES ('afds', 'asdf', 'asfd', 'afd', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
...
CREATE TABLE `t_member_apply_amount` (
  ...
  `apply_money` float DEFAULT NULL,
...
CREATE TABLE `t_member_auth` (
  ...
  `info_auth` enum('noapply','authstr','pass','failure') DEFAULT NULL,
  `info_auditor` varchar(32) DEFAULT NULL,
  `info_time` datetime DEFAULT NULL,
  `vip_auth` enum('noapply','authstr','pass','failure') DEFAULT NULL,
  `vip_auditor` varchar(32) DEFAULT NULL,
  `vip_time` datetime DEFAULT NULL,
  `email_auth` enum('noapply','authstr','pass','failure') DEFAULT NULL,
  `email_auditor` varchar(32) DEFAULT NULL,
  `email_time` datetime DEFAULT NULL,
  `mobile_auth` enum('noapply','authstr','pass','failure') DEFAULT NULL,
  `mobile_auditor` varchar(32) DEFAULT NULL,
  `mobile_time` datetime DEFAULT NULL,
  `credit_auth` enum('noapply','authstr','pass','failure') DEFAULT NULL,
  `credit_auditor` varchar(32) DEFAULT NULL,
  `credit_time` datetime DEFAULT NULL,
  `company_auth` enum('noapply','authstr','pass','failure') DEFAULT NULL,
  `company_auditor` varchar(32) DEFAULT NULL,
  `company_time` datetime DEFAULT NULL,
  `real_name_auth` enum('noapply','authstr','pass','failure') DEFAULT NULL,
  `real_name_auditor` varchar(32) DEFAULT NULL,
  `real_name_time` datetime DEFAULT NULL,
  `id_card_auth` enum('noapply','authstr','pass','failure') DEFAULT NULL,
  `id_card_auditor` varchar(32) DEFAULT NULL,
  `id_card_time` datetime DEFAULT NULL,
  `work_auth` enum('noapply','authstr','pass','failure') DEFAULT NULL,
  `work_auditor` varchar(32) DEFAULT NULL,
...
CREATE TABLE `t_member_estate` (
  ...
  `month_contributions` float DEFAULT NULL COMMENT '每月供款',
  `outstand_balances` float DEFAULT NULL COMMENT '尚欠贷款余额',
  `mortgage_bank` varchar(32) DEFAULT NULL COMMENT '按揭银行',
  `creater` varchar(32) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `updater` varchar(32) DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
...
CREATE TABLE `t_member_finance` (
  ...
  `ave_income` float DEFAULT NULL COMMENT '月均收入',
  `ave_income_des` varchar(32) DEFAULT NULL COMMENT '收入构成描述',
  `ave_expenses` float DEFAULT NULL COMMENT '月均支出',
  `age_expenses_des` varchar(32) DEFAULT NULL COMMENT '支出构成描述',
  `buy_estate` enum('havecat','nocat') DEFAULT NULL COMMENT '是否购房',
  `housing_conditions` enum('haveroom','noroom') DEFAULT NULL COMMENT '住房条件',
  `estate_value` float DEFAULT NULL COMMENT '房产价值',
  `buy_cat` enum('have_cat','no_cat') DEFAULT NULL COMMENT '是否购车',
  `cat_value` float DEFAULT NULL COMMENT '车辆价值',
  `cat_auth` enum('authstr','pass','failure') DEFAULT NULL,
  `company_name` varchar(32) DEFAULT NULL COMMENT '参股企业名称',
  `companies_capital_con` varchar(32) DEFAULT NULL COMMENT '参股企业出资额',
  `other_assets_described` varchar(32) DEFAULT NULL COMMENT '其他资产描述',
...
CREATE TABLE `t_member_integral` (
  ...
  `change_type` enum('increase','reduction') DEFAULT NULL,
  `change_value` int(20) DEFAULT NULL,
  `remark` varchar(255) DEFAULT NULL COMMENT '备注',
  `creater` varchar(32) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `updater` varchar(32) DEFAULT NULL,
...
CREATE TABLE `t_member_statistics` (
  ...
  `member_id` varchar(32) DEFAULT NULL COMMENT '会员Id',
  `total_borrowings` float DEFAULT NULL COMMENT '借款总额',
  `cumulative_loss_profit` float DEFAULT NULL COMMENT '累计亏盈',
  `already_total` float DEFAULT NULL COMMENT '已还总额',
  `wait_also_total` float DEFAULT NULL COMMENT '待还总额',
  `borrow_success` int(20) DEFAULT NULL COMMENT '借款成功次数',
  `normal_repayment` int(20) DEFAULT NULL COMMENT '正常还款次数',
  `advance_repayment` int(20) DEFAULT NULL COMMENT '提前还款次数',
  `late_repayment` int(20) DEFAULT NULL COMMENT '逾期还款次数',
  `late` int(20) DEFAULT NULL COMMENT '迟还次数',
  `website_substitute` int(20) DEFAULT NULL COMMENT '网站代还次数',
  `investment_total` float DEFAULT NULL COMMENT '投资总额',
  `tender_awards` float DEFAULT NULL COMMENT '投标奖励',
  `already_income_total` float DEFAULT NULL COMMENT '已收总额',
  `wait_income_total` float DEFAULT NULL COMMENT '待收总额',
  `promotion_awards` float DEFAULT NULL COMMENT '推广奖励',
  `upline_delta_awards` float DEFAULT NULL COMMENT '线下冲值奖励',
  `continue_awards` float DEFAULT NULL COMMENT '续投奖励',
  `creater` varchar(32) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `updater` varchar(32) DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
...
CREATE TABLE `t_member_vip` (
  ...
  `vip_integral` int(20) DEFAULT NULL COMMENT '积分',
...
-- ----------------------------
INSERT INTO `t_member_work` VALUES ('0d06ae74d5a50659c4c40d4ee980a748', 'cc', '32342343', 'cc', '2', '23', 'cc', '13798985542');
INSERT INTO `t_member_work` VALUES ('225b8f6a7863d52f947b265f869e48be', 'ee', '32234332', 'ee', '2', '21', 'ee', '3242424');
INSERT INTO `t_member_work` VALUES ('af', '323232', '2323323', '32', '23', '32', '3232', '32323232');
...
INSERT INTO `t_parameter_optgroup` VALUES ('676531ee865ec4ed5f3c3ca029596293', 'd8af2274018126845e1974120f96e8e2', 'type', '会员类型', null, null, '1', '', '8b25651c2d896297530b64e4b80ec503', '2014-02-21 10:24:04', null, null);
INSERT INTO `t_parameter_optgroup` VALUES ('70f3280adc4b70b24d945e247909adbc', null, 'memberMgr', '会员管理', null, null, '5', '', '8b25651c2d896297530b64e4b80ec503', '2014-02-21 10:23:11', null, null);
...
INSERT INTO `t_parameter_optgroup` VALUES ('b5ac6ebbc227b3a2cfe5b75ae48d81ca', 'd8af2274018126845e1974120f96e8e2', 'contactRelation', '联系人关系', null, null, '3', '', '8b25651c2d896297530b64e4b80ec503', '2014-02-21 11:03:24', null, null);
...
INSERT INTO `t_parameter_optgroup` VALUES ('d8af2274018126845e1974120f96e8e2', '70f3280adc4b70b24d945e247909adbc', 'member', '会员信息', null, null, '1', '', '8b25651c2d896297530b64e4b80ec503', '2014-02-21 10:23:33', null, null);
INSERT INTO `t_parameter_optgroup` VALUES ('f162bad386611ea6705db86adce95fc7', 'd8af2274018126845e1974120f96e8e2', 'maritalStatus', '婚姻状况', null, null, '2', '', '8b25651c2d896297530b64e4b80ec503', '2014-02-21 10:47:02', null, null);
...
INSERT INTO `t_parameter_optgroup_value` VALUES ('48219c94dc94c86116997c48c910500e', '676531ee865ec4ed5f3c3ca029596293', 'vip', 'vip会员', 'enable', '2', '', '8b25651c2d896297530b64e4b80ec503', '2014-02-21 10:32:30', null, null);
...
INSERT INTO `t_parameter_optgroup_value` VALUES ('88059e49f722a35f308078da1c5713d1', '676531ee865ec4ed5f3c3ca029596293', 'general', '普通会员', 'enable', '1', '', '8b25651c2d896297530b64e4b80ec503', '2014-02-21 10:25:07', null, null);
...
INSERT INTO `t_user` VALUES ('8b25651c2d896297530b64e4b80ec503', 'admin', '超级管理员', '5dc10e7826e648ec6f136974c38f81d0e5e1d0ae', 'e03b1b95ceff4db6', 'enable', 'admin', 'admin@glacier.cn', null, null, '2014-02-21 17:54:53', '127.0.0.1[本地]', '119', '8b25651c2d896297530b64e4b80ec503', '2014-01-16 00:00:00');

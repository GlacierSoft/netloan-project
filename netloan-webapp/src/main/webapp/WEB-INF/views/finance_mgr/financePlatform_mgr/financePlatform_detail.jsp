...
<form method="post" style="padding:15px">
	<table class="detailtable">
		...
		<tr>
			...
			<td>审核状态：</td>
			<td>
				<input name="auditState" value="${financePlatformData.auditState}" class="spinner" style="width:180px" readonly="readonly"/>
			</td>
		</tr>
		...
		<tr>
			<td>审核人：</td>
			<td>
				<input name="auditor" value="${financePlatformData.auditor}" class="spinner" style="width:180px" readonly="readonly"></input>
			</td>
			<td>审核时间：</td>
		...
		<tr>
			<td>创建人：</td>
			<td><input class="spinner" style="width:180px" value="${financePlatformData.creater}" readonly="readonly"/></td>
			<td>创建时间：</td>
		...
		<tr>
			<td>更新人：</td>
			<td><input class="spinner" style="width:180px" value="${financePlatformData.updater}" readonly="readonly"/></td>
			<td>更新时间：</td>

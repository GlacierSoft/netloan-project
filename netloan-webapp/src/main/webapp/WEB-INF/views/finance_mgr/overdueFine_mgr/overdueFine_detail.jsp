...
<form method="post" style="padding:15px">
	<table class="detailtable">
		...
		<tr>
			...
			<td>罚款金额：</td>
			<td><input class="spinner" style="width:168px" value="<fmt:formatDate  value="${overdueFineData.overdueFineMoney}" pattern="yyyy-MM-dd HH:mm:ss"/>" readonly="readonly"/></td>
		</tr>
		<tr>
			<td>应还款日期：</td>
			<td><input value="${overdueFineData.shouldPayDate}" class="spinner" style="width:168px" readonly="readonly"/></td>
			<td>实还款日期：</td>
			<td><input class="spinner" style="width:168px" value="${overdueFineData.actualPayDate}" readonly="readonly"/></td>
		</tr>
		<tr>
			<td>审核状态：</td>
			<td><input class="spinner" style="width:168px"   value="<fmt:formatDate  value="${overdueFineData.auditState}" pattern="yyyy-MM-dd HH:mm:ss"/>" readonly="readonly"/></td>
			<td>审核人：</td>
		...
		<tr>
			<td>创建人：</td>
			<td><input class="spinner" style="width:168px"   value="${overdueFineData.create}"  readonly="readonly"/></td>
			<td>录入时间：</td>

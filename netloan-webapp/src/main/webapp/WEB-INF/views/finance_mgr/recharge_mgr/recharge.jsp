...
<script type="text/javascript">
	...
	//状态下拉项
	$('#rechargeSearchForm_status').combobox({
		valueField : 'value',
		//height:18,
		width : 80,
		textField : 'label',
		...
		<form id="rechargeSearchForm">
			<table>
				<tr>
					...
					<td>审核状态：</td>
					<td>
						<input id="rechargeSearchForm_status" name="auditState" style="width: 80px;" class="spinner"/>
					</td>
					<td>创建时间：</td>
					<td>
					...
					<td>
						<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-standard-zoom-in',plain:true" onclick="glacier.finance_mgr.recharge_mgr.recharge.rechargeDataGrid.datagrid('load',glacier.serializeObject($('#rechargeSearchForm')));">查询</a>
						<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-standard-zoom-out',plain:true" onclick="$('#rechargeSearchForm input').val('');glacier.finance_mgr.recharge_mgr.recharge.rechargeDataGrid.datagrid('load',{});">重置条件</a>
					</td>
				</tr>
			</table>
		</form>

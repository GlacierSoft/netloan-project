	...
	<table class="formtable">
		<tr>
			...
			<td>
				...
				<input name="questionDes" class="easyui-validatebox spinner" style="width:268px" required="true" value="${questionData.questionDes}" validType="customReg['^[\u0391-\uFFE5]{2,10}$','<fmt:message key="ParameterQuestion.questionDes.illegal"/>']"/>
			</td>
		</tr>
		<tr>
			<td>排序：</td>

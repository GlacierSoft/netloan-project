	...
	<table class="detailtable">
		<tr>
			...
			<td class="forminputtable"><!-- 当表格行存在两个要显示的td,使用该forminputtable样式可以进行适当的空间调整  -->
				...
				<input class="spinner" style="width:168px"  value="${applyAmountData.memberRealName}"  />
			</td>
			<td>申请类型：</td>
			<td><input id="applyAmount_mgr_applyAmount_detail_applyType" class="spinner" style="width:168px" /></td>
		</tr>
		<tr>
			<td>原来额度：</td>

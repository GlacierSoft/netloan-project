...
<form id="borrowingLoan_mgr_borrowingLoan_detail" method="post" style="padding:15px">
    ...
    <div title="认购信息" style="padding:30px">
    	<fieldset id="borrowingLoan_mgr_borrowingLoan_detail_Tender" style="padding:10px;" class="spinner">
			...
			<table  class="detailtable">
				...
				<tr>
					<td>最小认购单位(元)：</td>
					<td><input id="borrowingLoan_mgr_borrowingLoan_detail_lowestSub" name="lowestSub" class="spinner" style="width:198px" value="<fmt:formatNumber value='${borrowingLoanData.lowestSub}' pattern="#,#00.00元"/>" readonly="readonly"/></td>
					<td>认购总份数：</td>

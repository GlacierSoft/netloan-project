...
<div id="borrowingLoan_mgr_borrowingLoan_detail" style="padding:15px">
    <div title="进行复审" style="padding:15px">
    	<fieldset id="borrowingLoan_mgr_borrowingLoan_detail_proceedAudit" style="padding:10px;" class="spinner">
			...
			<form method="post" style="padding:15px">
				<table class="formtable">
					...
					<tr>
						<td>复审处理意见：</td>
						<td colspan="3"><textarea id="borrowingLoan_mgr_borrowingLoan_secondAudit_secondAdvice" name="secondAdvice" style="width:512px;" maxlength="255" class="spinner formta">${borrowingLoanData.secondAdvice}</textarea></td>
					</tr>
					<tr>
						<td>复审站内信通知：</td>
						<td colspan="3"><textarea id="borrowingLoan_mgr_borrowingLoan_secondAudit_secondMesNotice" name="secondMesNotice" style="width:512px;" maxlength="255" class="spinner formta">${borrowingLoanData.secondMesNotice}</textarea></td>
					</tr>
				</table>
			</form>
		</fieldset>

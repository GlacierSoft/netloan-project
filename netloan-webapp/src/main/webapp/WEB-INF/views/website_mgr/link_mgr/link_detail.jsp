...
<form method="post" style="padding:15px">
	<table class="detailtable">
		...
		<tr>
			<td>创建人：</td>
			<td><input class="spinner" style="width:168px" value="${linkData.creater}" readonly="readonly"/></td>
			<td>创建时间：</td>
		...
		<tr>
			<td>更新人：</td>
			<td><input class="spinner" style="width:168px" value="${linkData.updater}" readonly="readonly"/></td>
			<td>跟新时间：</td>

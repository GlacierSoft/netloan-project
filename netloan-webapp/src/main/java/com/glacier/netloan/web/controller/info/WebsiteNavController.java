...
import com.glacier.netloan.service.info.WebsiteNavService;
...
public class WebsiteNavController extends AbstractController{
	...
	private Object intoIndexParea(){
		ModelAndView mav = new ModelAndView("info_mgr/websiteNav_mgr/websiteNav");
		return mav;
	}
	...
	private Object intowebsiteNavFormParea(String webNavId){
		ModelAndView  mav = new ModelAndView("info_mgr/websiteNav_mgr/websiteNav_form");
